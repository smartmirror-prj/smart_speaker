...
class CK_VISIBLE_PUBLIC CkRest  : public CkClassWithCallbacks
{
	...
	// Adds a path parameter. A path parameter is a string that will be replaced in any
	// uriPath string passed to a method. For example, if name is "fileId" and value is
	// "1R_70heIyzIAu1_u0prXbYcaIiJRVkgBl", then a uriPath argument of
	// "/drive/v3/files/fileId" will be transformed to
